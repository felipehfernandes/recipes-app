# Recipes App!
  ...
  ⚠️ A base de dados é composta de 2 APIs distintas, uma para comidas e outra para bebidas.
  ...
  Para o projeto ser validado, foram desenvolvidos testes unitários para cada componente da aplicação
